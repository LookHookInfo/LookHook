...
export default function Services() {
  ...
  const services: Service[] = [
    {
      ...
      icon: <span className="text-white text-5xl font-extrabold transform rotate-[15deg] scale-95">₿</span>,
  ...
  return (
    <>
      {services.map((service) => openModal === service.title && service.modal)}
      ...
      <div className="max-w-[85rem] px-4 py-4 sm:px-6 lg:px-8 lg:py-6 mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-start gap-6">
          {services.map((service) => (
            ...
            >
              <div className="flex justify-center items-center size-12 bg-blue-600 rounded-xl p-6">{service.icon}</div>
              <div className="mt-5">
                ...
                <p className="mt-1 text-gray-400 dark:text-neutral-400">{service.description}</p>
