  ...
  if (hasClaimed) {
    ...
    mainAction = (
      <button
        ...
        className="inline-flex items-center justify-center px-3 py-1 text-sm font-medium rounded-lg border border-neutral-700 text-white bg-neutral-800 hover:bg-neutral-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
      >
        {buttonContent}
      </button>
    );
